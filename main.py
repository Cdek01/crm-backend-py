...
from api.endpoints import roles, imports, files, ai, users, shares, calendar_views, calendar, integrations, dashboards, history
...
app.include_router(history.router, prefix="/api/history", tags=["History (Undo/Redo)"])
